          ...
          <div class="app-brand justify-content-center mt-5">
            <a href="index.html" class="app-brand-link gap-2">
              <span class="app-brand-logo demo">
                ...
                <img src="assets/logonew.png" style="width: 6rem;" alt="" srcset="">

              </span>
              <span class="app-brand-text demo text-heading fw-semibold">FRESHWAY</span>
            </a>
          </div>
          <!-- /Logo -->

          <div class="card-body mt-2">
            <h4 class="mb-2">Welcome to Freshway Admin Panel! 👋</h4>
            <p class="mb-2">Please sign-in to your account</p>
            <p class="mb-4 text-muted ">Contact FRESWAY admin for user name and password</p>
            <?php if (isset($_GET['error'])) { ?>
              <p class="error text-danger"><?php echo $_GET['error']; ?></p>
            <?php } ?>

            <form id="formAuthentication" class="mb-3" action="config/login2.php" method="POST">
