    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          <!-- Content -->
          <h4 class="py-1 mb-1">New Order For:</h4>
          <h5 class="py-1 mb-1"><?php echo $client ?> - <?php echo $deliverydate ?></h5>
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button type="button" class="nav-link waves-effect " role="tab" data-bs-toggle="tab"
                        data-bs-target="#cat<?php echo $row['id'] ?>" aria-controls="cat<?php echo $row['id'] ?>"
                        aria-selected="false">
                        <?php echo $row['name'] ?>
                      </button>
                    </li>
                ...
                <div class="tab-content p-0 col-6">
                  ...
                  <div class="tab-pane fade " id="cat<?php echo $row2['category_id'] ?>" role="tabpanel">
                    <div class="list-group">
                      <?php
                            $sql3 = "SELECT * FROM menu_list WHERE isactive=1 AND category_id=$catId";
                            $result3 = $conn->query($sql3);
                            if ($result3->num_rows > 0) {
                              while ($row3 = $result3->fetch_assoc()) {
                            ?>

                      <a href="javascript:void(0);" data-itemid="<?php echo $row3['id'] ?>"
                        data-bigunit="<?php echo $row3['bigunit'] ?>" data-name="<?php echo $row3['name'] ?>"
                        data-price="<?php echo $row3['price'] ?>"
                        class="list-group-item list-group-item-action waves-effect add-item"
                        onclick="openModal('<?php echo $row3['id'] ?>', '<?php echo $row3['name'] ?>', '<?php echo $row3['bigunit'] ?>', '<?php echo $row3['price'] ?>', '<?php echo $row3['code'] ?>')">
                        <span class="fw-bold"><?php echo $row3['name'] ?></span>
                        &nbsp;&nbsp;<?php echo $row3['bigunit'] ?>&nbsp;&nbsp;&nbsp;&nbsp;$
                        <?php echo $row3['price'] ?>
                      </a>
                      <?php
                              }
              ...
              <div class="card-body">
                <div class="d-flex flex-row justify-content-between">
                  ...
                  <div class="d-flex flex-column align-items-start">
                    <p>Order Number:&nbsp;<span class="fw-bold"> <?php echo sprintf("%04d", $orderId); ?></span></p>
                    <p>Client:&nbsp;<span class="fw-bold"> <?php echo explode('-', $client)[1] ?></span></p>
                    <p>Delivery Date:&nbsp;<span class="fw-bold"> <?php echo $deliverydate ?></span></p>
                ...
                <div class="table-responsive text-nowrap">
                  ...
                  <input type="hidden" id="clientName" value="<?php echo $client ?>" name="">
...
function updateSummary() {
  ...
  var subTotalFinal = subTotal - vat;
...
function sendOrderData() {
  ...
  for (var i = 0; i < itemIds.length; i++) {
    ...
    var clientSend = nameClient.value;
  ...
  $.ajax({
    url: '../config/addorderitemsclient.php', // Replace with your server script URL
    method: 'POST',
    data: {
    ...
    success: function(response) {
      ...
      openPrintWindow();
      window.location.href = 'ordersclient.php';
    },
