                        ...
                        <div class="tab-pane fade " id="cat<?php echo $row2['category_id'] ?>" role="tabpanel">
                          <div class="list-group">
                            ...
                            ?>
                                ...
                                <a href="javascript:void(0);" data-itemid="<?php echo $row3['id'] ?>" data-bigunit="<?php echo $row3['bigunit'] ?>" data-name="<?php echo $row3['name'] ?>" data-price="<?php echo $row3['price'] ?>" class="list-group-item list-group-item-action waves-effect add-item" onclick="openModal('<?php echo $row3['id'] ?>', '<?php echo $row3['name'] ?>', '<?php echo $row3['bigunit'] ?>', '<?php echo $row3['price'] ?>', '<?php echo $row3['code'] ?>')">
