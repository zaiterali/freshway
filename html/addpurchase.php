...
<?php
  ...
  if (isset($_POST['startOrder'])) {
    ...
    $invNum = validate($_POST['invNum']);

    $supplierId = explode('-', $supplier)[0];
    $supplierName = explode('-', $supplier)[1];

    $sql = "INSERT INTO po_list (user_id, supplier, order_note, po_invoicenum) 
    VALUES ($userId, '$supplier', '$ordernote', '$invNum')";

    if (mysqli_query($conn, $sql)) {
      $lastInsertedId = mysqli_insert_id($conn);

      // Redirect to neworderitems.php with the order ID
      header("Location: ../html/newpoitems.php?supplier=$supplier&ordernote=$ordernote&orderid=$lastInsertedId&invnum=$invNum");
    } else {
      // Redirect to neworder.php with an error parameter
      header("Location: ../html/newpoitems.php?error");
    }
    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          <!-- Content -->
          <h4 class="py-1 mb-2">New Purchase Order</h4>
                  ...
                  <div class="row mt-2 gy-4">
                    <div class="col-md-6">
                      <div class="form-floating form-floating-outline">
                        <input class="form-control" list="suppliers" type="text" id="supplier" name="supplier"
                          autofocus=" " required>
                        <datalist id="suppliers">
                          <?php
                            $sql = "SELECT id, companyname, contactperson FROM suppliers WHERE isactive=1";
                    ...
                    <div class="col-md-6">
                      <div class="form-floating form-floating-outline">
                        <input class="form-control" type="text" id="invNum" name="invNum" autofocus=" " required>
